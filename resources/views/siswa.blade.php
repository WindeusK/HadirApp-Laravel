          ...
          <div class="row-cols-3 ">
            <div class="card mt-5">
              ...
              <label for="" class="mt-4 ml-4">
                Nama<input type="text" name="nama" placeholder="data wajib diisi" class="ml-4 input-group-lg pl-5 text-sm-left">
              </label> 
               <label for="" class="mt-3 ml-4">
                Kode <input type="text" name="kode" placeholder="data wajib diisi" class="ml-4 input-group-lg pl-5 text-sm-left">
              </label> 
               <label for="" class="mt-3 ml-4">
               ...
               <label for="" class="mt-3 ml-1 mr-2">
                pinjam<input type="date" name="tglpinjam" placeholder="data wajib diisi" class="ml-5 input-group-lg pl-5 text-sm-left">
              </label>
