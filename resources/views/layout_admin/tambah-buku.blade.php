          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item menu-open">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="./tambah.html" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Tambah Buku</p>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="./buku.html" class="nav-link">
                    <i class="far fa-circle nav-icon"></i>
                    <p>List Buku</p>
                  </a>
                </li>
          ...
          <div class="row-cols-1">
            <div class="card"> 
              ...
              <label for="" class="mt-4 ml-4">
               ...
               <label for="" class="mt-3 ml-4">
                Penulis <input type="text" placeholder="data wajib diisi" class="ml-3 input-group-lg pl-5 text-sm-left">
              </label>
               <label for="" class="mt-3 ml-4">
                Penerbit <input type="text" placeholder="data wajib diisi" class="ml-2 input-group-lg pl-5 text-sm-left">
              </label>
               <label for="" class="mt-3 ml-4">
                Tahun  <input type="text" placeholder="data wajib diisi" class="ml-4 input-group-lg pl-5 text-sm-left">
              </label>
