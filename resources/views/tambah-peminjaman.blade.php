      ...
      <section class="content">
        <div class="container-fluid">
          <div class="row-cols-1">
            <div class="card"> 
              <h4 class="mt-3 ml-4 text-bold h5">Tambah Peminjaman</h4>
              <label for="" class="mt-4 ml-4">
               ...
               <label for="" class="mt-3 ml-4">
                pinjam<input type="text" placeholder="data wajib diisi" class="ml-4 input-group-lg pl-5 text-sm-left">
              </label>
               <label for="" class="mt-3 ml-4">
                Kembali  <input type="text" placeholder="data wajib diisi" class="ml-3 input-group-lg pl-5 text-sm-left">
              </label>
